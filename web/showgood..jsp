...
<div class="htmleaf-container">
    <header class="htmleaf-header">
        ...
        <div class="htmleaf-links">
            ...
            <a class="htmleaf-icon icon-htmleaf-arrow-forward-outline" href="login2.jsp" title="重新登陆" target="_blank"><span> 返回下载页</span></a>
        </div>
    </header>
    <div class="container">
        <div class="row">
                ...
                <table class="table table-bordered">
                    ...
                    <%
                        ...
                        while (true) {
                            if (!(rs.next())) break;%>
                    <tr>
                        <form action="/showgood1.jsp" method="post">
                            <!-- 输出结果集 -->
                            <td><%=rs.getString("ID") %>
                            </td>
